...
namespace StaticDotNet.SourceGenerators.Enumerations.Infrastructure;
...
#pragma warning disable 0809
	...
	public override readonly int GetHashCode() => throw new NotSupportedException( "Hash code not supported" );

	[Obsolete( "HashCode is a mutable struct and should not be compared with other HashCodes.", error: true )]
	[EditorBrowsable( EditorBrowsableState.Never )]
	public override readonly bool Equals( object? obj ) => throw new NotSupportedException( "Equality not supported" );
